    ...
    return(
      <div id='hero-header' className='flex justify-center my-24'>
        <div className="flex flex-col justify-center items-center">
          ...
          <h2 className='text-lg animate-fade-in-delayed bg-dark-gray bg-opacity-30 rounded-lg border-2 border-white border-opacity-20 px-4 py-1'>Full Stack Developer</h2>
        </div>
      </div>
    )
  }
