...
export default function Bio() {
  return (
    <section id='bio'>
        <div className='section flex gap-4 justify-evenly'>
            <div className='flex flex-col gap-6'>
                <h2 className="text-5xl font-bold text-white">
                I'm Noah Arevalo. I live in Virginia, where I build the future.
                </h2>
                <p className='text-white font-light text-opacity-40 leading-relaxed'>
            ...
            <div className="flex flex-col gap-6">
                <Link href = "https://github.com/Tsuyae" rel="noopener noreferrer" target="_blank">Follow me on Github</Link>
